      ...
      <div class="auth-modal-content">
        ...
        <form v-if="mode === 'signup'" @submit.prevent="handleSignUp" class="auth-form">
          <div class="form-group">
            ...
            <input id="signup-email" v-model="form.email" type="email" required placeholder="Enter your email"
              :disabled="authStore.loading" />
          </div>
          ...
          <div class="form-group">
            ...
            <input id="signup-password" v-model="form.password" type="password" required
              placeholder="Enter your password" :disabled="authStore.loading" />
          </div>

          <div class="form-group">
            <label for="confirm-password">Confirm Password</label>
            <input id="confirm-password" v-model="form.confirmPassword" type="password" required
              placeholder="Confirm your password" :disabled="authStore.loading" />
          </div>
        ...
        <form v-if="mode === 'forgot'" @submit.prevent="handleResetPassword" class="auth-form">
          <div class="form-group">
            ...
            <input id="reset-email" v-model="form.email" type="email" required placeholder="Enter your email"
              :disabled="authStore.loading" />
          </div>
...
.btn-primary {
  /* Uses global button style from base.css */
}
